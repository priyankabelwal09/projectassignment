...
import attrition_model

# Project Directories
PACKAGE_ROOT = Path(attrition_model.__file__).resolve().parent
#print(PACKAGE_ROOT)
...
class ModelConfig(BaseModel):
    ...
    dept_mappings: Dict[str, int]
    edu_mappings: Dict[str, int]
    gender_mappings: Dict[str, int]
    jobrole_mappings: Dict[str, int]
    martialsts_mappings: Dict[str, int]
    overtime_mappings: Dict[str, int]
    #attrition_mappings: Dict[str, int]
